...
![](./image/hellotriangle.png)

完整的程序源码可以在[这里](./02_hello_triangle.cpp)找到。
...
![](./image/vertex_array_objects_ebo.png)
...
![](./image/hellotriangle2.png)
 ...
 如果你遇到任何错误，回头检查代码，看看是否遗漏了什么。同时，你可以在[这里](./02_hello_square.cpp)找到全部源码，你也可以在评论区自由提问。
